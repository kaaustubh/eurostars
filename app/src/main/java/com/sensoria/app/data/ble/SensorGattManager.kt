...
class SensorGattManager(private val gatt: BluetoothGatt) {
    ...
    /**
     * Enable notifications for a Sensoria characteristic.
     * Public method for enabling Sensoria Streaming Service characteristics.
     */
    @SuppressLint("MissingPermission")
    fun enableNotificationForSensoriaCharacteristic(serviceUuid: UUID, characteristicUuid: UUID) {
        enableNotificationForCharacteristic(serviceUuid, characteristicUuid, queueDescriptor = true)
        processNextDescriptorWrite()
    }
