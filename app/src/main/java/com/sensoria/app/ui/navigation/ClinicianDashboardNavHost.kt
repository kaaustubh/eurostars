...
import com.sensoria.app.ui.screens.clinician.dashboard.ClinicianTab
import com.sensoria.app.ui.screens.clinician.patients_tab.ClinicianGaitAnalysisScreen
import com.sensoria.app.ui.screens.clinician.patients_tab.PatientSessionsScreen
...
fun ClinicianDashboardNavHost(navController: NavHostController) {
    NavHost(
        ...
        composable(ClinicianTab.Settings.route)  { 
            com.sensoria.app.ui.screens.clinician.settings.SettingsScreen()
        }
    }
}
