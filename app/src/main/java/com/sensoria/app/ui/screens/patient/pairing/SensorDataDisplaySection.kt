...
import com.sensoria.app.ui.components.HeatmapUtils
...
fun SensorDataDisplaySection(
    ...
    leftSensorType: com.sensoria.app.data.ble.SensorType? = null,
    rightSensorType: com.sensoria.app.data.ble.SensorType? = null,
...
private fun SensorDataCard(
    ...
    temp: Float?,
    time: Long?,
    sensorType: com.sensoria.app.data.ble.SensorType? = null
) {
    // Determine max channels based on sensor type
