package com.sensoria.app.ui.screens.patient.pairing
...
import com.sensoria.app.data.ble.BleRepository
...
import com.sensoria.app.data.SessionRepository
...
fun PairingTabScreen() {
    ...
    val leftEffectiveState = if (!isBluetoothEnabled) {
        com.sensoria.app.data.ble.SensorConnectionState.DISCONNECTED
    } else {
        leftConnectionState?.state ?: com.sensoria.app.data.ble.SensorConnectionState.IDLE
    }
    
    val rightEffectiveState = if (!isBluetoothEnabled) {
        com.sensoria.app.data.ble.SensorConnectionState.DISCONNECTED
    } else {
        rightConnectionState?.state ?: com.sensoria.app.data.ble.SensorConnectionState.IDLE
    }
    
    val leftConnected = leftEffectiveState == com.sensoria.app.data.ble.SensorConnectionState.CONNECTED
    val rightConnected = rightEffectiveState == com.sensoria.app.data.ble.SensorConnectionState.CONNECTED
    ...
    val leftSensorState = SensorPairingState(
        ...
        sensorType = pairingStatus.leftSensor.sensorType
    )
    ...
    val rightSensorState = SensorPairingState(
        ...
        sensorType = pairingStatus.rightSensor.sensorType
    )
        ...
        Column(
            ...
            if (leftConnected || rightConnected) {
                SensorDataDisplaySection(
                    ...
                    leftSensorType = pairingStatus.leftSensor.sensorType,
                    rightSensorType = pairingStatus.rightSensor.sensorType,
                    modifier = Modifier.padding(horizontal = 24.dp)
                )
                Spacer(modifier = Modifier.height(32.dp))
            }
            ...
            com.sensoria.app.ui.screens.shared.AboutSection(
